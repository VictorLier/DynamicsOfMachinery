...
\begin{tikzpicture}[scale=\linewidth/130cm]
    ...
    \draw[dim] (0, 11) -- (12.3, 11)node[midway, above]{$L_{D1}$};    % Disk 1 length
    \draw[dim] (0, 11) -- (18.2, 11)node[above]{$L_{D2}$};    % Disk 2 length
    \draw[dim] (0, 11) -- (57.5, 11)node[midway, above]{$L_S$};    % Shaft length

    \draw[dim] (0, -12) -- (35.5, -12)node[midway, below]{$L_{R1}$};    % Reaction 1 length
    \draw[dim] (0, -12) -- (109.5, -12)node[midway, below]{$L_{R2}$};    % Reaction 2 length
